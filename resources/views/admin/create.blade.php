                ...
                <div class="list-group">
                    <div class="list-group-item py-3" data-acc-step>
                        <a href="!#" class="mb-0 form-collapse-tab" data-content="1">
                            <h5 class="mb-0" data-content="1" data-acc-title>Categoria Jogo</h5>
                        </a>
                    ...
                    <div class="list-group-item py-3" data-acc-step>
                        ...
                        <div class="2" data-acc-content>
                            <div class="my-3">
                                @include('admin.card-create', ['name'=>'Tag', 'placeholder'=>'Digite uma tag',
                                'id'=>'tag', 'route'=> isset($route) ? $route : Route('tags-create'), 'content'=>$tags
                                ?? []])
                            </div>
                        </div>
                    </div>
                    <div class="list-group-item py-3" data-acc-step>
                        <a href="#" class="mb-0 form-collapse-tab" data-content="3">
                            <h5 class="mb-0" data-acc-title>Categoria</h5>
                        </a>
                        <div class="3" data-acc-content>
                            @include('admin.card-create', ['name'=>'categoria', 'placeholder'=>'Digite uma categoria',
                            'id'=>'category', 'route'=> Route('category-create'), 'content'=>[]])
                        </div>
                    </div>
                    <div class="list-group-item py-3" data-acc-step>
