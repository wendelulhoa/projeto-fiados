        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin-store-payment')}}" id="payment-form" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
...
@section('script-js')
    ...
    <script>
        ...
        $('#next-page').click(function(){
            var id = $('#clients').val();
            var linkUpdate = "{{route('admin-new-payment', ['id'=>0])}}";
            window.location.href = linkUpdate.replace('payment/0', `payment/${id}`)
        });
        ...
        $('#payment-form').submit(function(e) {
            ...
            sweetAlert(`Tem que deseja realizar o pagamento ?`, action);
        });
    </script>
@endsection